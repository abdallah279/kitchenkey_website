<template>
    <form class="w-100" @submit.prevent="activePassword">
        ...
        <div class="w-100 d-flex gap-1 mt-3 justify-content-center fs13">
            <button type="button" class="cu-auto c-gray_mid border-0 bg-transparent">{{ $t('formBtns.receiveCode') }}</button>
